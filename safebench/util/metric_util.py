...
def get_route_scores(record_dict, time_out=30):
    ...
    for key, score in all_scores.items():
        penalty_score += score * weights[key]
    all_scores['penalty_score'] = penalty_score
...
if __name__ == '__main__':
    ...
    # all_scores, normalized_scores, penalty_score = get_scores(record)
    # print('overall score:', penalty_score)
